...
public class GameOverWorld extends World
{
    ...
    public GameOverWorld(GameController controller, int score)
    {
        ...
        GreenfootImage boardImage = new GreenfootImage("display/game_over_sign.png");
    ...
    void displayTopScore() {
        ...
        getBackground().drawImage(currentScore, 390, 210);

    }

    void displayMyScore() {
        GreenfootImage score = new GreenfootImage(this.score.toString(), 50, Color.WHITE, null);
        getBackground().drawImage(score, 400, 310);
